...
#frame15
background15 = [["FFFFFF"]*total_columns for rows in range(total_rows)]

im_fill(background15,[1,13],[5,5],"301A1A")

im_fill(background15,[19,19],[17,17],"301A1A")

im_show(background15)

frame_list=[background,background3,background2,background4,
            background5,background6,background7,background12,
            background13,background14,background9,background10,background11,background15]
fps=1
